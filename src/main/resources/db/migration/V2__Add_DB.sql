...
values ('Moscow', 'Lenina', '+7(989)8005007', 'aaa@mail.ru', '2022-01-01', 1, 'CREATED');

insert into public.manager(first_name, last_name, date_birth, employment_date, phone, email, center_id, status)
values ('Petr', 'Petrov', '1998-05-05', '2022-01-01', '+7(989)8005057', 'ppp@mail.ru', 1, 'CREATED');
...
insert into public.visa(visa_type, visa_term, purpose, country, price, center_id, status)
values ('long', 180, 'tourism', 'italy', 10000, 1, 'CREATED');