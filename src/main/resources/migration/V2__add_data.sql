...
values ('Krasnodar', 'Krasnaya', '89898989898', 'polina.visa@mail.ru', '01.01.2022', 1, 'CREATED');
...
insert into public.request(travel_date, documents, payment_date, status)
values (31.08.2022, 'PASSWORD', '01.08.2022', 'CREATED');
